...
np.save("Cluster_GBWA_E=150mj_PXe=100torr_fstart=20cm_fstop=100cm.npy",scanned_WA.data)
np.save("Cluster_GBNA_E=150mj_PXe=100torr_fstart=20cm_fstop=100cm.npy",scanned_NA.data)