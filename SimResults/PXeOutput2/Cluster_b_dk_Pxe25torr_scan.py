...
np.save("GBWA_E=150mj_PXe="+str(pulse_params["PXe"])+"torr_fstart=20cm_fstop=100cm.npy",scanned_WA.data)
np.save("GBNA_E=150mj_PXe="+str(pulse_params["PXe"])+"torr_fstart=20cm_bstop=100cm.npy",scanned_NA.data)