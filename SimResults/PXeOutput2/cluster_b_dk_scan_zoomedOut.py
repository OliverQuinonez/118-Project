...
bsamples = 5
brange = (f_to_b(omega0,20e-2),0.5)# confocal perameter [m] (corresponds to f=20cm to f=100cm)
...
dk_samples = bsamples
dk_range = brange
dk =np.linspace(2/b_int[-1],2/b_int[1],dk_samples)
...
np.save("Cluster_GBWA_E=150mj_PXe=100torr_fstart=20cm_bstop=0p5m.npy",scanned_WA.data)
np.save("Cluster_GBNA_E=150mj_PXe=100torr_fstart=20cm_bstop=0p5m.npy",scanned_NA.data)