...
pulse_params = {'b' : 2.3e-2,            # [m] confocal parameter
            'energy' : 170e-3,       # [J] single pulse energy original
...
PAr_int =np.array( [20,30,40,43,46,
                   150,
                   250,270,276,282,302,
                   450,
                   545,565,575,585,605])
...
np.save("GBWA_Output",scanned_WA.data)
