...
np.save("Cluster_GBWA_E=150mj_PXe=10torr_fstart=20cm_bstop=0p5m.npy",scanned_WA.data)
np.save("Cluster_GBNA_E=150mj_PXe=10torr_fstart=20cm_bstop=0p5m.npy",scanned_NA.data)