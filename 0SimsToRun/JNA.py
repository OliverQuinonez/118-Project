...
pulse_params = {'b' : 0,            # [m] confocal parameter
...
scan_WA = scan_builder(single_func, params_WA, [PXe_scan,b_scan])
...
np.save("JNA_E=17mJ_fscan_20cm_50cm_75cm_PXeScan_1Torr_100Torr_PXeSamples=100",scanned_WA.data)
